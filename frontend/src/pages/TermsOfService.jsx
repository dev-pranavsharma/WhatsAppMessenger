  ...
  return (
    ...
    <div className="bg-gray-50 min-h-screen py-12 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-lg p-8 border border-gray-200">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">1. Acceptance of Terms</h2>
        <p className="text-gray-700 mb-4">By using our services, you agree to these terms. Please read them carefully.</p>

        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">2. Description of Service</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">3. Eligibility</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">4. Account Registration & Security</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">5. User Obligations</h2>
        <p className="text-gray-700 mb-2">By using Impretio, you agree to:</p>
        <ul className="list-disc list-inside text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">6. WhatsApp & Meta Integration</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">7. Fees and Payments</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">8. Intellectual Property</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">9. Modifications</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">10. Termination</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">11. Disclaimers</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">12. Limitation of Liability</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">13. Governing Law</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-2">14. Contact Information</h2>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-sm text-gray-500 mt-12">Last updated: June 28, 2025</p>
      </div>
    </div>
    </>
  );
